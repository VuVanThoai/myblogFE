...
export class ArticlesCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe((value) => {
      ...
      this.meta.addTag({name: 'description', content: 'Đây là trang tổng hợp thông tin với chủ đề ' + this.categoryByShortUrl?.name} );
      this.meta.addTag({name: 'og:description', content: 'Đây là trang tổng hợp thông tin với chủ đề ' + this.categoryByShortUrl?.name} );
      this.meta.addTag({name: 'og:title', content: 'Đây là trang tổng hợp thông tin với chủ đề ' + this.categoryByShortUrl?.name} );
